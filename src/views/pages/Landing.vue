    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="OSAIL-LIASO Logo" height="50" class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">OSAIL-LIASO</span> </a>
                ...
                <div class="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2" style="top: 120px">
                    ...
                    <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                        ...
                        <!-- <Button label="Register" class="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500"></Button> -->
                        <Button label="FR" class="p-button-rounded border-none ml-5 font-light text-white line-height-2 bg-blue-500"></Button>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    <h1 class="text-6xl font-bold text-gray-900 line-height-2"><span class="font-light block">Welcome to <span class = "font-bold ">OSAIL</span> / Bienvenue à <span class = "font-bold ">LIASO</span></span></h1>
            ...
            <div id="features" class="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                <div class="grid justify-content-center">
                    <div class="col-12 text-center mt-8 mb-4">
                        ...
                        <span class="text-600 text-2xl">At a high level</span>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Absolutely Free</h5>
                                <span class="text-600">Test immediately and then bring your own key integration.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">New Tools</h5>
                                <span class="text-600">Experiment with new tools continually being released.</span>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                <div class="flex align-items-center justify-content-center bg-indigo-200" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                                    <i class="pi pi-fw pi-book text-2xl text-indigo-700"></i>
                                </div>
                                <h5 class="mb-2 text-900">Learn</h5>
                                <span class="text-600">Learn from videos, code, architectures, and documentation.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Agents and Assistants</h5>
                                <span class="text-600">Utilize a library of advanced Agents and Assistant definitions.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Open Source</h5>
                                <span class="text-600">Find all this code on GitHub for your own projects.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Accessible</h5>
                                <span class="text-600">Build on an accessible PrimeVue framework.</span>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                <div class="flex align-items-center justify-content-center bg-teal-200 mb-3" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                                    <i class="pi pi-fw pi-globe text-2xl text-teal-700"></i>
                                </div>
                                <h5 class="mb-2 text-900">Ready to Use</h5>
                                <span class="text-600">Easy to deploy and launch locally or in your datacenter.</span>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                <div class="flex align-items-center justify-content-center bg-blue-200 mb-3" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                                    <i class="pi pi-fw pi-cloud text-2xl text-blue-700"></i>
                                </div>
                                <h5 class="mb-2 text-900">Community Driven</h5>
                                <span class="text-600">Driven by a growing and learning community of practitioners.</span>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                <div class="flex align-items-center justify-content-center bg-purple-200 mb-3" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                                    <i class="pi pi-fw pi-info-circle text-2xl text-purple-700"></i>
                                </div>
                                <h5 class="mb-2 text-900">Advanced Tools</h5>
                                <span class="text-600">Experiment with leading edge interfaces for AI.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <div class="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                            <!-- <h3 class="text-gray-900 mb-2">Name</h3>
                            <span class="text-gray-600 text-2xl">Organization</span> -->
                            <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4" style="max-width: 800px">
                                OSAIL provides the fastest means to innovate and experiment with the latest tools and technologies in the world of LLMs, to test new tools, and to contribute your own ideas. New videos and examples drop every few days. Use the tool or clone the code base to deploy to your own data center.
                            </p>
                ...
                <div class="grid justify-content-between">
                    <div class="col-12 md:col-2" style="margin-top: -1.5rem">
                        <a @click="smoothScroll('#home')" class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                            ...
                            <h4 class="font-medium text-3xl text-900">OSAIL-LIASO</h4>
                        </a>
                    </div>
                    ...
                    <div class="col-12 md:col-10 lg:col-7">
                        <div class="grid text-center md:text-left">
                            <!-- <div class="col-12 md:col-3">
                                <h4 class="font-medium text-2xl line-height-3 mb-3 text-900">Header</h4>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Sub Item 1</a>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Sub Item 2</a>
                                <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Sub Item 3</a>
                            </div>
